...
#if MANUAL_TUNING
  PID pid(&input, &output, &setpoint, 0, 0, 0, REVERSE);
#else
  PID pid(&input, &output, &setpoint, 70, 240, 1.9, REVERSE);
#endif
...
void setup()
{
    ...
    mpu.setZAccelOffset(1093); // 1688 factory default for my test chip
